...
use support::{decl_module, decl_storage, decl_event, StorageValue, StorageMap, Parameter, ensure};
use sr_primitives::traits::{SimpleArithmetic, Bounded, One, Member};
...
impl<T: Trait> Module<T> {
	...
	fn do_breed(sender: &T::AccountId, kitty_id_1: T::KittyIndex, kitty_id_2: T::KittyIndex) -> Result<T::KittyIndex, &'static str> {
